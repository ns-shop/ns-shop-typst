...
// @enduml
#img("55image.png", cap: "Biểu đồ quan hệ mô tả cấu trúc các bảng và quan hệ giữa chúng trong cơ sở dữ liệu của website TMĐT")
...
#img("Screenshot 2023-06-07 015605.png", cap: "Giao diện website khi responsive ở màn hình máy tính (1280px)", width: 90%)
