...
#img("Picture1.png", cap: "Đồ thị người dùng sử dụng các nền tảng Zalo, Facebook ...trong 2 năm")
...
#tabl(columns: (auto, 1fr), cap: "Cấu hình HTTP",
    [*Key*], [*Value*],
...
#tabl(columns: (1fr, 1fr, 1fr), cap: "Địa chỉ IP",
